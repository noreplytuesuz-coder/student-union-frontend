  ...
  return (
    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="w-full max-w-md">
      <div className="text-center mb-8">
        ...
        <p className="mt-2 text-muted-foreground">{t("Sign in to your Student Union account")}</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        {signIn.isError && <div className="text-sm text-red-500">{t("Invalid credentials. Please try again.")}</div>}
