  ...
  return (
    <div ref={containerRef} className="flex flex-col gap-32 pb-20">
      ...
      <section className="relative min-h-[80vh] flex items-center px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto w-full">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="text-lg sm:text-xl text-muted-foreground font-sans max-w-lg">{t("home.hero.subtitle")}</p>
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-10">
          <div>
            <h2 className="font-display text-4xl sm:text-5xl font-bold mb-3">
              {t("home.featured.title")} <span className="text-gradient">{t("events.title")}</span>
            </h2>
            <p className="font-sans text-muted-foreground max-w-2xl text-lg">{t("home.featured.subtitle")}</p>
          </div>
        ...
        <div className="flex flex-col gap-12">
          <div className="text-center">
            ...
            <p className="font-sans text-muted-foreground max-w-2xl mx-auto text-lg">
              {t(
                "We provide the platform, you bring the energy. From massive parties to intense hackathons, we've got you covered.",
              )}
            </p>
          </div>
            ...
            >
              <div className="absolute right-0 top-0 w-1/2 h-full opacity-30 group-hover:opacity-50 transition-opacity">
                ...
                <div
                  ...
                  style={{
                    backgroundImage: "radial-gradient(#39FF14 2px, transparent 2px)",
              ...
              <div className="absolute inset-0 p-8 z-10 flex flex-col justify-center">
                ...
                <p className="font-sans text-gray-400 max-w-md mb-6">
                  {t(
                    "Got an idea? We provide funding, mentorship, and a platform to launch your startup, app, or movement.",
                  )}
                </p>
                <Button
                  variant="ghost"
      ...
      <section className="py-12 bg-black text-white neo-border-y overflow-hidden flex flex-col gap-6 relative group">
        <h3 className="text-center font-sans text-sm tracking-widest text-muted-foreground">
          {t("TRUSTED BY OUR PARTNERS")}
        </h3>
